...
InitializeEventsScript:
	...
	setevent EVENT_OAKS_LAB_OAK ; Kanto hack (N1b): Oak is out looking for #MON until the lab intro; the rival is in the lab from the start, as in Yellow
	setevent EVENT_EARLS_ACADEMY_EARL
	setevent EVENT_RADIO_TOWER_ROCKET_TAKEOVER
	setevent EVENT_GOLDENROD_CITY_ROCKET_TAKEOVER
	setevent EVENT_RADIO_TOWER_CIVILIANS_AFTER
	setevent EVENT_SAFFRON_CITY_CIVILIANS_AFTER ; Kanto hack (M8 11c): SAFFRON's civilians are off the map until TEAM ROCKET leaves
...
; boulders, and B3F's two non-toggleable decoys, start visible.
	...
	setevent EVENT_VICTORY_ROAD_2F_BOULDER_HIDDEN ; Kanto hack (M10 13g): was EVENT_RIVAL_VICTORY_ROAD (row renamed in place)
	...
	; Kanto hack (M11 14k): EVENT_RED_IN_MT_SILVER retired (Lance holds Red's tile).
