...
PewterNidoranSpeechHouseBG1Q1Bookshelf:
...
PewterNidoranSpeechHouse_MapEvents:
	...
	def_bg_events
	bg_event  0,  1, BGEVENT_UP, PewterNidoranSpeechHouseBG1Q1Bookshelf ; BG1Q1
	bg_event  1,  1, BGEVENT_UP, PewterNidoranSpeechHouseBG1Q1Bookshelf ; BG1Q1
	bg_event  7,  1, BGEVENT_UP, PewterNidoranSpeechHouseBG1Q1Bookshelf ; BG1Q1
