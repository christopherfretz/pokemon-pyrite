...
VermilionPidgeyHouseBG1Q1Bookshelf:
...
VermilionPidgeyHouse_MapEvents:
	...
	def_bg_events
	bg_event  0,  1, BGEVENT_UP, VermilionPidgeyHouseBG1Q1Bookshelf ; BG1Q1
	bg_event  1,  1, BGEVENT_UP, VermilionPidgeyHouseBG1Q1Bookshelf ; BG1Q1
	bg_event  7,  1, BGEVENT_UP, VermilionPidgeyHouseBG1Q1Bookshelf ; BG1Q1
