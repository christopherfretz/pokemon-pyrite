...
ProfElmScript:
	faceplayer
	opentext
; Kanto hack (M11 14k, D140): Crystal's post-E4 S.S.TICKET gift is gone (the
; Champion holds the S.S. Anne's TICKET, and the S.S.AQUA takes it); the
; MASTER BALL waits for the MT.SILVER LANCE instead of the RISINGBADGE.
