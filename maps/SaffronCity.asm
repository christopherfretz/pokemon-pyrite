...
SaffronCity_MapEvents:
	...
	object_event 31, 12, SPRITE_BIRD, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, SaffronCityPidgeotScript, EVENT_SAFFRON_CITY_CIVILIANS_AFTER
