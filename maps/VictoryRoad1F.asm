...
;
; Yellow's 10x9 VICTORY_ROAD_1F re-cut by scripts/vr_blk.py; on TILESET_KANTO_CAVE since CT1 (scripts/ct1_kanto_cave.py).
...
;
; 13g: boulder switch TILE (17,13); the barrier is BLOCK (4,6) -- $25 closed,
; changeblock to $1d when open (Yellow's ReplaceTileBlock, verbatim since CT1).
...
VictoryRoad1FSwitchCallback:
	...
	iffalse .done
	changeblock 8, 12, $1d ; Yellow block (4,6) -> $1d
.done
	endcallback
