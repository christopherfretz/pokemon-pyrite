...
IcePath1FTMEarthquake: ; Kanto hack (M11 14a): was Crystal's HM07 WATERFALL; OAK gives HM07 now
...
IcePath1F_MapEvents:
	...
	def_object_events
	object_event 31,  7, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, IcePath1FTMEarthquake, EVENT_ICE_PATH_1F_TM_EARTHQUAKE
