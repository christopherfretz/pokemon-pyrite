...
; _FuchsiaCityPokecenterGuyText in data/text/text_2.asm; docs/BG1-BENCH-AND-SHELVES.md).
...
FuchsiaPokecenter1F_MapEvents:
	...
	def_bg_events
	bg_event  0,  4, BGEVENT_LEFT, FuchsiaPokecenter1FBenchGuyScript ; BG1 Yellow bench guy
