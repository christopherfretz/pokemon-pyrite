...
; Kanto hack (F3, docs/AUDIT-FULL-GAME-LEFTOVERS.md): Yellow's Oak speech,
; verbatim (vendor/pokeyellow/data/text/text_3.asm:435-464).  _OakText1 =
; _OakSpeechText1, _OakText2 = _OakSpeechText2A, _OakText3 = _OakSpeechText2B
; (printed after the Pikachu cry).  Crystal's _OakText4/_OakText5 beats are gone.
_OakText1::
	text "Hello there!"
	line "Welcome to the"
	cont "world of #MON!"
