...
MapGroup_Fuchsia:
	...
	map FuchsiaMeetingRoom, TILESET_GAME_CORNER, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_CELADON_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE ; Kanto hack (M7 10a): was SAFARI_ZONE_MAIN_OFFICE (Yellow: 7x4 on the LAB tileset -- re-cut in 10g)
...
; FISHGROUP_NONE; the areas take Yellow's own super-rod rows.
	...
	map FuchsiaGoodRodHouse, TILESET_HOUSE, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_CELADON_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
