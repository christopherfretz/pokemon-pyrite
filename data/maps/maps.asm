...
MapGroup_Cerulean:
	...
	map Route4, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_4, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_LAKE ; L1: Yellow's Super Rod here is GOLDEEN/SEAKING
	...
	map Route25, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_25, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_SHORE ; L1: Yellow's Super Rod here is KRABBY/KINGLER
	map CeruleanCity, TILESET_KANTO, TOWN, LANDMARK_CERULEAN_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_AUTO, FISHGROUP_LAKE ; L1: Yellow's Super Rod here is GOLDEEN/SEAKING
...
MapGroup_Lavender:
	...
	map Route12, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_12, MUSIC_ROUTE_12, FALSE, PALETTE_AUTO, FISHGROUP_WHIRL_ISLANDS ; Kanto hack (M5 8l): D7 said FISHGROUP_SHORE, but Shore's Good/Super slots hit time_group 0/1 == CORSOLA, a Gen 2 mon.  FISHGROUP_WHIRL_ISLANDS is 100% Gen 1 (MAGIKARP/KRABBY/KINGLER + time_group 18/19 HORSEA, SEADRA) and its Super Rod set is exactly Yellow's Route 12 line (HORSEA/SEADRA, vendor/pokeyellow/data/wild/super_rod.asm:15).  See docs/M5-LAVENDER.md 8l findings.
