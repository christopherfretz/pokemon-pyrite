...
MapGroup_Indigo:
	...
	map AgathasRoom, TILESET_KANTO_E4_TOWER, INDOOR, LANDMARK_INDIGO_PLATEAU, MUSIC_LAVENDER_TOWN, FALSE, PALETTE_DAY, FISHGROUP_NONE ; Kanto hack (M10 13j): Yellow's 5x6 on CEMETERY; Yellow's POKEMON_TOWER -> M5's tower track, MUSIC_LAVENDER_TOWN (D131, K6); no phone (Gen 2)
