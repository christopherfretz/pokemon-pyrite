...
; MUSIC_VIRIDIAN_CITY).  Every FISHGROUP is NONE for now: G14 forbids
; SHORE/OCEAN/POND/LAKE on a Kanto map and 12o opens the five new
; FISHGROUP_KANTO_* rows (D102) that SEAFOAM B3F/B4F actually want.  The four
...
; encounters -- PokemonTower3F-7F is the precedent.
	...
	map SeafoamIslandsB3F, TILESET_CAVE, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_NONE
	map SeafoamIslandsB4F, TILESET_CAVE, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_NONE
	map CinnabarMart, TILESET_MART, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map CinnabarLab, TILESET_KANTO_INTERIOR, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map CinnabarLabTradeRoom, TILESET_KANTO_INTERIOR, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map CinnabarLabMetronomeRoom, TILESET_KANTO_INTERIOR, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map CinnabarLabFossilRoom, TILESET_KANTO_INTERIOR, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
