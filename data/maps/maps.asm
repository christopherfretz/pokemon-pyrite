...
MapGroup_Celadon:
	...
	map Route16Gate, TILESET_KANTO_GATE, GATE, LANDMARK_ROUTE_16, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
; interiors.  INDOOR, not DUNGEON: Yellow's ROCKET HIDEOUT has no wild table.
	...
	map Route16Gate2F, TILESET_KANTO_GATE, INDOOR, LANDMARK_ROUTE_16, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
