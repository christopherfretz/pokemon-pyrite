...
MapGroup_Celadon:
	...
	map Route17Route18Gate, TILESET_KANTO_GATE, GATE, LANDMARK_ROUTE_17, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
; interiors.  INDOOR, not DUNGEON: Yellow's ROCKET HIDEOUT has no wild table.
	...
	map Route18Gate2F, TILESET_KANTO_GATE, INDOOR, LANDMARK_ROUTE_18, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
