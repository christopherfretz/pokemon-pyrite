...
MapGroup_Indigo:
	...
	map LoreleisRoom, TILESET_KANTO_GYM, INDOOR, LANDMARK_INDIGO_PLATEAU, MUSIC_GYM, FALSE, PALETTE_DAY, FISHGROUP_NONE ; Kanto hack (M10 13j): Yellow's 5x6 on GYM; MUSIC_GYM per D131 (K6); no phone (Gen 2)
	map BrunosRoom, TILESET_KANTO_GYM, INDOOR, LANDMARK_INDIGO_PLATEAU, MUSIC_INDIGO_PLATEAU, FALSE, PALETTE_DAY, FISHGROUP_NONE ; Kanto hack (M10 13j): Yellow's 5x6 on GYM; Yellow's DUNGEON1 -> MUSIC_INDIGO_PLATEAU stand-in (D131, K6); no phone (Gen 2)
	map AgathasRoom, TILESET_KANTO_TOWER, INDOOR, LANDMARK_INDIGO_PLATEAU, MUSIC_LAVENDER_TOWN, FALSE, PALETTE_DAY, FISHGROUP_NONE ; Kanto hack (M10 13j): Yellow's 5x6 on CEMETERY; Yellow's POKEMON_TOWER -> M5's tower track, MUSIC_LAVENDER_TOWN (D131, K6); no phone (Gen 2)
	map LancesRoom, TILESET_KANTO_GYM, INDOOR, LANDMARK_INDIGO_PLATEAU, MUSIC_INDIGO_PLATEAU, FALSE, PALETTE_DAY, FISHGROUP_NONE ; Kanto hack (M10 13j): Yellow's 13x13 on GYM; Yellow's DUNGEON1 -> MUSIC_INDIGO_PLATEAU stand-in (D131, K6); no phone (Gen 2)
	map ChampionsRoom, TILESET_KANTO_GYM, INDOOR, LANDMARK_INDIGO_PLATEAU, MUSIC_INDIGO_PLATEAU, FALSE, PALETTE_DAY, FISHGROUP_NONE ; Kanto hack (M10 13k): Yellow's 4x4 on GYM; Yellow's MUSIC_INDIGO_PLATEAU; no phone (Gen 2)
	map HallOfFame, TILESET_KANTO_GYM, INDOOR, LANDMARK_INDIGO_PLATEAU, MUSIC_PALLET_TOWN, FALSE, PALETTE_DAY, FISHGROUP_NONE ; Kanto hack (M10 13k): Yellow's 5x4 on GYM; Yellow's MUSIC_PALLET_TOWN; no phone (Gen 2)
