...
MapGroup_Olivine:
	...
	map OlivineCity, TILESET_JOHTO, TOWN, LANDMARK_OLIVINE_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE_L78
...
MapGroup_Mahogany:
	...
	map Route42, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_42, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_LAKE_L82
	map Route44, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_44, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_REMORAID ; Kanto hack (A251): G/S Route 44 REMORAID
...
MapGroup_Dungeons:
	...
	map RuinsOfAlphOutside, TILESET_JOHTO, ROUTE, LANDMARK_RUINS_OF_ALPH, MUSIC_UNION_CAVE, FALSE, PALETTE_AUTO, FISHGROUP_POND_L70
	...
	map UnionCave1F, TILESET_CAVE, CAVE, LANDMARK_UNION_CAVE, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE_L61
	map UnionCaveB1F, TILESET_CAVE, CAVE, LANDMARK_UNION_CAVE, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE_L78
	map UnionCaveB2F, TILESET_CAVE, CAVE, LANDMARK_UNION_CAVE, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_SHORE_L78
	map SlowpokeWellB1F, TILESET_CAVE, CAVE, LANDMARK_SLOWPOKE_WELL, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE_L61
	map SlowpokeWellB2F, TILESET_CAVE, CAVE, LANDMARK_SLOWPOKE_WELL, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE_L78
	...
	map IlexForest, TILESET_FOREST, CAVE, LANDMARK_ILEX_FOREST, MUSIC_UNION_CAVE, FALSE, PALETTE_NITE, FISHGROUP_POND_L65
	...
	map MountMortar1FOutside, TILESET_DARK_CAVE, CAVE, LANDMARK_MT_MORTAR, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE_L82
	map MountMortar1FInside, TILESET_DARK_CAVE, CAVE, LANDMARK_MT_MORTAR, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map MountMortar2FInside, TILESET_DARK_CAVE, CAVE, LANDMARK_MT_MORTAR, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE_L82
	map MountMortarB1F, TILESET_DARK_CAVE, CAVE, LANDMARK_MT_MORTAR, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE_L82
	...
	map SilverCaveRoom2, TILESET_CAVE, CAVE, LANDMARK_SILVER_CAVE, MUSIC_LIGHTHOUSE, TRUE, PALETTE_NITE, FISHGROUP_LAKE_L95
	...
	map DarkCaveBlackthornEntrance, TILESET_DARK_CAVE, CAVE, LANDMARK_DARK_CAVE, MUSIC_DARK_CAVE, TRUE, PALETTE_DARK, FISHGROUP_LAKE_L91
	...
	map TohjoFalls, TILESET_CAVE, CAVE, LANDMARK_TOHJO_FALLS, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE_L58
	map DiglettsCave, TILESET_KANTO_CAVE, CAVE, LANDMARK_DIGLETTS_CAVE, MUSIC_DUNGEON2, TRUE, PALETTE_NITE, FISHGROUP_SHORE ; K6c: Yellow MUSIC_DUNGEON2
	...
	map RockTunnel1F, TILESET_KANTO_CAVE, CAVE, LANDMARK_ROCK_TUNNEL, MUSIC_DUNGEON3, TRUE, PALETTE_DARK, FISHGROUP_SHORE ; K6c: Yellow MUSIC_DUNGEON3
	map RockTunnelB1F, TILESET_KANTO_CAVE, CAVE, LANDMARK_ROCK_TUNNEL, MUSIC_DUNGEON3, TRUE, PALETTE_DARK, FISHGROUP_SHORE ; K6c: Yellow MUSIC_DUNGEON3
	...
	map VictoryRoad1F, TILESET_KANTO_CAVE, CAVE, LANDMARK_VICTORY_ROAD, MUSIC_DUNGEON3, TRUE, PALETTE_NITE, FISHGROUP_NONE ; Kanto hack (M10 13f): Yellow's VICTORY ROAD 1F; no water on any VR floor, so FISHGROUP_NONE; K6c: Yellow MUSIC_DUNGEON3
	map MtMoon1F, TILESET_KANTO_CAVE, CAVE, LANDMARK_MT_MOON, MUSIC_DUNGEON3, TRUE, PALETTE_NITE, FISHGROUP_SHORE ; K6c: Yellow MUSIC_DUNGEON3
	map MtMoonB1F, TILESET_KANTO_CAVE, CAVE, LANDMARK_MT_MOON, MUSIC_DUNGEON3, TRUE, PALETTE_NITE, FISHGROUP_SHORE ; K6c: Yellow MUSIC_DUNGEON3
	map MtMoonB2F, TILESET_KANTO_CAVE, CAVE, LANDMARK_MT_MOON, MUSIC_DUNGEON3, TRUE, PALETTE_NITE, FISHGROUP_SHORE ; K6c: Yellow MUSIC_DUNGEON3
	...
	map VictoryRoad2F, TILESET_KANTO_CAVE, CAVE, LANDMARK_VICTORY_ROAD, MUSIC_DUNGEON3, TRUE, PALETTE_NITE, FISHGROUP_NONE ; Kanto hack (M10 13f); K6c: Yellow MUSIC_DUNGEON3
	map VictoryRoad3F, TILESET_KANTO_CAVE, CAVE, LANDMARK_VICTORY_ROAD, MUSIC_DUNGEON3, TRUE, PALETTE_NITE, FISHGROUP_NONE ; Kanto hack (M10 13f); K6c: Yellow MUSIC_DUNGEON3
	map KantoPowerPlant, TILESET_KANTO_FACILITY, DUNGEON, LANDMARK_POWER_PLANT, MUSIC_DUNGEON1, TRUE, PALETTE_DAY, FISHGROUP_NONE ; Kanto hack (M10 13l): Yellow's 20x18 POWER PLANT on FACILITY.  DUNGEON = wild grass on the floor + ESCAPE ROPE/DIG, as the Mansion.  Yellow's MUSIC_DUNGEON1 (K6c).  No water: FISHGROUP_NONE
...
MapGroup_Ecruteak:
	...
	map EcruteakCity, TILESET_JOHTO, TOWN, LANDMARK_ECRUTEAK_CITY, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_AUTO, FISHGROUP_POND_L70
...
MapGroup_Blackthorn:
	...
	map BlackthornCity, TILESET_JOHTO, TOWN, LANDMARK_BLACKTHORN_CITY, MUSIC_AZALEA_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_POND_L87
...
; (SEAFOAM -> Yellow's DUNGEON2, MUSIC_MT_MOON until K6c ported MUSIC_DUNGEON2), D105 (the MANSION -> MUSIC_LIGHTHOUSE as the K6 placeholder for
...
; encounters -- PokemonTower3F-7F is the precedent.
	map SeafoamIslands1F, TILESET_KANTO_CAVE, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_DUNGEON2, TRUE, PALETTE_NITE, FISHGROUP_NONE ; K6c: Yellow MUSIC_DUNGEON2
	map SeafoamIslandsB1F, TILESET_KANTO_CAVE, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_DUNGEON2, TRUE, PALETTE_NITE, FISHGROUP_NONE ; K6c: Yellow MUSIC_DUNGEON2
	map SeafoamIslandsB2F, TILESET_KANTO_CAVE, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_DUNGEON2, TRUE, PALETTE_NITE, FISHGROUP_NONE ; K6c: Yellow MUSIC_DUNGEON2
	map SeafoamIslandsB3F, TILESET_KANTO_CAVE, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_DUNGEON2, TRUE, PALETTE_NITE, FISHGROUP_KANTO_SEAFOAM ; Kanto hack (M9 12o): Yellow's B3F/B4F row (D102); K6c: Yellow MUSIC_DUNGEON2
	map SeafoamIslandsB4F, TILESET_KANTO_CAVE, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_DUNGEON2, TRUE, PALETTE_NITE, FISHGROUP_KANTO_SEAFOAM ; Kanto hack (M9 12o): Yellow's B3F/B4F row (D102); K6c: Yellow MUSIC_DUNGEON2
	...
	map PokemonMansion1F, TILESET_KANTO_FACILITY, DUNGEON, LANDMARK_CINNABAR_ISLAND, MUSIC_POKEMON_MANSION_YELLOW, TRUE, PALETTE_DAY, FISHGROUP_NONE
	map PokemonMansion2F, TILESET_KANTO_FACILITY, DUNGEON, LANDMARK_CINNABAR_ISLAND, MUSIC_POKEMON_MANSION_YELLOW, TRUE, PALETTE_DAY, FISHGROUP_NONE
	map PokemonMansion3F, TILESET_KANTO_FACILITY, DUNGEON, LANDMARK_CINNABAR_ISLAND, MUSIC_POKEMON_MANSION_YELLOW, TRUE, PALETTE_DAY, FISHGROUP_NONE
	map PokemonMansionB1F, TILESET_KANTO_FACILITY, DUNGEON, LANDMARK_CINNABAR_ISLAND, MUSIC_POKEMON_MANSION_YELLOW, TRUE, PALETTE_DAY, FISHGROUP_NONE
	map CinnabarGym, TILESET_KANTO_FACILITY, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_NONE
; M12a: Yellow plays MUSIC_ROUTES3 in the house, ROUTE 19's own track.
	map SummerBeachHouse, TILESET_KANTO_BEACH_HOUSE, INDOOR, LANDMARK_ROUTE_19, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_NONE
; MEW1: the SEALED LAB under the MANSION -- lab art, the MANSION's own track.
	map PokemonMansionSealedLab, TILESET_KANTO_LAB, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_POKEMON_MANSION_YELLOW, FALSE, PALETTE_DAY, FISHGROUP_NONE
...
MapGroup_Cerulean:
	...
	map CeruleanCave1F, TILESET_KANTO_CAVE, CAVE, LANDMARK_CERULEAN_CITY, MUSIC_DUNGEON1, TRUE, PALETTE_NITE, FISHGROUP_KANTO_CERULEAN_CAVE_1F ; K6c: Yellow MUSIC_DUNGEON1; M10P: Yellow's cave, super_rod.asm GOLDEEN 25, SEAKING 35/45/55
	map CeruleanCave2F, TILESET_KANTO_CAVE, CAVE, LANDMARK_CERULEAN_CITY, MUSIC_DUNGEON1, TRUE, PALETTE_NITE, FISHGROUP_NONE ; M10P: no water, no super_rod row
	map CeruleanCaveB1F, TILESET_KANTO_CAVE, CAVE, LANDMARK_CERULEAN_CITY, MUSIC_DUNGEON1, TRUE, PALETTE_NITE, FISHGROUP_KANTO_CERULEAN_CAVE_B1F ; M10P: super_rod.asm GOLDEEN 30, SEAKING 40/50/60
...
MapGroup_LakeOfRage:
	...
	map Route43, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_43, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_POND_L82
...
MapGroup_Violet:
	...
	map Route35, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_35, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_POND_L70
...
MapGroup_Goldenrod:
	table_width MAP_LENGTH
	map Route34, TILESET_JOHTO_MODERN, ROUTE, LANDMARK_ROUTE_34, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_SHORE_L65
	map GoldenrodCity, TILESET_JOHTO_MODERN, TOWN, LANDMARK_GOLDENROD_CITY, MUSIC_GOLDENROD_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE_L65
...
MapGroup_Vermilion:
	...
	map DiglettsCaveRoute11, TILESET_KANTO_CAVE, CAVE, LANDMARK_DIGLETTS_CAVE, MUSIC_DUNGEON2, TRUE, PALETTE_NITE, FISHGROUP_SHORE ; Kanto hack (docs/M4-VERMILION.md, 7c); K6c: Yellow MUSIC_DUNGEON2
...
MapGroup_FastShip:
	table_width MAP_LENGTH
	map OlivinePort, TILESET_PORT, ROUTE, LANDMARK_OLIVINE_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN_L78
	map VermilionPort, TILESET_KANTO_DOCK, ROUTE, LANDMARK_VERMILION_CITY, MUSIC_SS_ANNE, FALSE, PALETTE_AUTO, FISHGROUP_KANTO_VERMILION_DOCK ; Kanto hack (7g): Yellow plays MUSIC_SS_ANNE here (data/maps/songs.asm).  That Gen 1 track is unported (milestone K6), so the dock shares the ship shells' MUSIC_SS_ANNE placeholder.  Kanto hack (M5 8m): Yellow-faithful Kanto fishing (vendor/pokeyellow/data/wild/super_rod.asm), Yellow's VERMILION_DOCK row: TENTACOOL 10/15, STARYU 15, SHELLDER 10
	...
	map SSAnne1F, TILESET_SHIP, INDOOR, LANDMARK_SS_ANNE, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE ; Kanto hack (docs/M4-VERMILION.md, 7c).  K6a: Yellow's MUSIC_SS_ANNE (data/maps/songs.asm)
	map SSAnne2F, TILESET_SHIP, INDOOR, LANDMARK_SS_ANNE, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE ; Kanto hack (docs/M4-VERMILION.md, 7c).  K6a: Yellow's MUSIC_SS_ANNE (data/maps/songs.asm)
	map SSAnne3F, TILESET_SHIP, INDOOR, LANDMARK_SS_ANNE, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE ; Kanto hack (docs/M4-VERMILION.md, 7c).  K6a: Yellow's MUSIC_SS_ANNE (data/maps/songs.asm)
	map SSAnneB1F, TILESET_SHIP, INDOOR, LANDMARK_SS_ANNE, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE ; Kanto hack (docs/M4-VERMILION.md, 7c).  K6a: Yellow's MUSIC_SS_ANNE (data/maps/songs.asm)
	map SSAnneBow, TILESET_SHIP, INDOOR, LANDMARK_SS_ANNE, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE ; Kanto hack (docs/M4-VERMILION.md, 7c).  K6a: Yellow's MUSIC_SS_ANNE (data/maps/songs.asm)
	map SSAnneKitchen, TILESET_SHIP, INDOOR, LANDMARK_SS_ANNE, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE ; Kanto hack (docs/M4-VERMILION.md, 7c).  K6a: Yellow's MUSIC_SS_ANNE (data/maps/songs.asm)
	map SSAnneCaptainsRoom, TILESET_SHIP, INDOOR, LANDMARK_SS_ANNE, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE ; Kanto hack (docs/M4-VERMILION.md, 7c).  K6a: Yellow's MUSIC_SS_ANNE (data/maps/songs.asm)
	map SSAnne1FRooms, TILESET_SHIP, INDOOR, LANDMARK_SS_ANNE, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE ; Kanto hack (docs/M4-VERMILION.md, 7c).  K6a: Yellow's MUSIC_SS_ANNE (data/maps/songs.asm)
	map SSAnne2FRooms, TILESET_SHIP, INDOOR, LANDMARK_SS_ANNE, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE ; Kanto hack (docs/M4-VERMILION.md, 7c).  K6a: Yellow's MUSIC_SS_ANNE (data/maps/songs.asm)
	map SSAnneB1FRooms, TILESET_SHIP, INDOOR, LANDMARK_SS_ANNE, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE ; Kanto hack (docs/M4-VERMILION.md, 7c).  K6a: Yellow's MUSIC_SS_ANNE (data/maps/songs.asm)
	assert_table_length NUM_FAST_SHIP_MAPS

MapGroup_Indigo:
	table_width MAP_LENGTH
	map IndigoPlateau, TILESET_KANTO_PLATEAU, TOWN, LANDMARK_INDIGO_PLATEAU, MUSIC_INDIGO_PLATEAU, FALSE, PALETTE_AUTO, FISHGROUP_NONE ; Kanto hack (M10 13e-2): Yellow's 10x9 forecourt on the PLATEAU tileset; no water, so no fish group (Crystal had FISHGROUP_SHORE)
	map IndigoPlateauPokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_INDIGO_PLATEAU, MUSIC_INDIGO_PLATEAU, FALSE, PALETTE_DAY, FISHGROUP_NONE ; Kanto hack (M10 13h): indoors, no water
	map LoreleisRoom, TILESET_KANTO_E4, INDOOR, LANDMARK_INDIGO_PLATEAU, MUSIC_GYM, FALSE, PALETTE_DAY, FISHGROUP_NONE ; Kanto hack (M10 13j): Yellow's 5x6 on GYM; MUSIC_GYM per D131 (K6); no phone (Gen 2)
	map BrunosRoom, TILESET_KANTO_E4, INDOOR, LANDMARK_INDIGO_PLATEAU, MUSIC_DUNGEON1, FALSE, PALETTE_DAY, FISHGROUP_NONE ; Kanto hack (M10 13j): Yellow's 5x6 on GYM; Yellow's MUSIC_DUNGEON1 (K6c); no phone (Gen 2)
	map AgathasRoom, TILESET_KANTO_E4_TOWER, INDOOR, LANDMARK_INDIGO_PLATEAU, MUSIC_POKEMON_TOWER, FALSE, PALETTE_DAY, FISHGROUP_NONE ; Kanto hack (M10 13j): Yellow's 5x6 on CEMETERY; Yellow's POKEMON_TOWER -> M5's tower track, MUSIC_POKEMON_TOWER (D131, K6); no phone (Gen 2)
	map LancesRoom, TILESET_KANTO_E4, INDOOR, LANDMARK_INDIGO_PLATEAU, MUSIC_INDIGO_PLATEAU, FALSE, PALETTE_DAY, FISHGROUP_NONE ; Kanto hack (M10 13j): Yellow's 13x13 on GYM; Yellow's LANCES_ROOM is MUSIC_INDIGO_PLATEAU too (K6c); no phone (Gen 2)
	map ChampionsRoom, TILESET_KANTO_E4, INDOOR, LANDMARK_INDIGO_PLATEAU, MUSIC_INDIGO_PLATEAU, FALSE, PALETTE_DAY, FISHGROUP_NONE ; Kanto hack (M10 13k): Yellow's 4x4 on GYM; Yellow's MUSIC_INDIGO_PLATEAU; no phone (Gen 2)
	map HallOfFame, TILESET_KANTO_E4, INDOOR, LANDMARK_INDIGO_PLATEAU, MUSIC_PALLET_TOWN, FALSE, PALETTE_DAY, FISHGROUP_NONE ; Kanto hack (M10 13k): Yellow's 5x4 on GYM; Yellow's MUSIC_PALLET_TOWN; no phone (Gen 2)
	map Route23, TILESET_KANTO_PLATEAU, ROUTE, LANDMARK_ROUTE_23, MUSIC_INDIGO_PLATEAU, FALSE, PALETTE_AUTO, FISHGROUP_KANTO_ROUTE_23 ; Kanto hack (M10 13e-1): Yellow's ROUTE 23 (Yellow plays MUSIC_INDIGO_PLATEAU)
...
; the rest houses and the secret house all play MUSIC_SAFARI_ZONE (D59; Yellow's
; own track since K6c), the gate and the
...
MapGroup_Lavender:
	...
	map LavenderTown, TILESET_KANTO, TOWN, LANDMARK_LAVENDER_TOWN, MUSIC_LAVENDER_YELLOW, FALSE, PALETTE_AUTO, FISHGROUP_SHORE ; K6c: Yellow MUSIC_LAVENDER
	...
	map MrFujisHouse, TILESET_HOUSE, INDOOR, LANDMARK_LAVENDER_TOWN, MUSIC_LAVENDER_YELLOW, FALSE, PALETTE_DAY, FISHGROUP_SHORE ; K6c: Yellow MUSIC_LAVENDER
	map LavenderCuboneHouse, TILESET_HOUSE, INDOOR, LANDMARK_LAVENDER_TOWN, MUSIC_LAVENDER_YELLOW, FALSE, PALETTE_DAY, FISHGROUP_SHORE ; K6c: Yellow MUSIC_LAVENDER
	map LavenderNameRater, TILESET_HOUSE, INDOOR, LANDMARK_LAVENDER_TOWN, MUSIC_LAVENDER_YELLOW, FALSE, PALETTE_DAY, FISHGROUP_SHORE ; K6c: town theme, as D11 (Yellow: CITIES2 / POKECENTER / no map)
	map LavenderMart, TILESET_MART, INDOOR, LANDMARK_LAVENDER_TOWN, MUSIC_LAVENDER_YELLOW, FALSE, PALETTE_DAY, FISHGROUP_SHORE ; K6c: town theme, as D11 (Yellow: CITIES2 / POKECENTER / no map)
	map SoulHouse, TILESET_HOUSE, INDOOR, LANDMARK_LAVENDER_TOWN, MUSIC_LAVENDER_YELLOW, FALSE, PALETTE_DAY, FISHGROUP_SHORE ; K6c: town theme, as D11 (Yellow: CITIES2 / POKECENTER / no map)
	map PokemonTower1F, TILESET_KANTO_TOWER, INDOOR, LANDMARK_LAVENDER_TOWN, MUSIC_POKEMON_TOWER, FALSE, PALETTE_DAY, FISHGROUP_SHORE ; Kanto hack (docs/M5-LAVENDER.md, 8b)
...
; Kanto hack (docs/M6-TOWER.md, 9a): POKéMON TOWER 2F-7F.  Music is Yellow's
; own MUSIC_POKEMON_TOWER on every floor and 1F, ported in K6a (D14's
; MUSIC_LAVENDER_TOWN stand-in retired; docs/K6-MUSIC.md).
...
; and so reproduces Gen 1's "encounters anywhere indoors".
	map PokemonTower2F, TILESET_KANTO_TOWER, INDOOR, LANDMARK_LAVENDER_TOWN, MUSIC_POKEMON_TOWER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PokemonTower3F, TILESET_KANTO_TOWER, DUNGEON, LANDMARK_LAVENDER_TOWN, MUSIC_POKEMON_TOWER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PokemonTower4F, TILESET_KANTO_TOWER, DUNGEON, LANDMARK_LAVENDER_TOWN, MUSIC_POKEMON_TOWER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PokemonTower5F, TILESET_KANTO_TOWER, DUNGEON, LANDMARK_LAVENDER_TOWN, MUSIC_POKEMON_TOWER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PokemonTower6F, TILESET_KANTO_TOWER, DUNGEON, LANDMARK_LAVENDER_TOWN, MUSIC_POKEMON_TOWER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PokemonTower7F, TILESET_KANTO_TOWER, DUNGEON, LANDMARK_LAVENDER_TOWN, MUSIC_POKEMON_TOWER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	assert_table_length NUM_LAVENDER_MAPS

MapGroup_Silver:
	table_width MAP_LENGTH
	map Route28, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_28, MUSIC_INDIGO_PLATEAU, FALSE, PALETTE_AUTO, FISHGROUP_POND_L95
	map SilverCaveOutside, TILESET_KANTO, TOWN, LANDMARK_SILVER_CAVE, MUSIC_INDIGO_PLATEAU, FALSE, PALETTE_AUTO, FISHGROUP_POND_L95
...
MapGroup_Celadon:
	...
	map CeladonGameCorner, TILESET_GAME_CORNER, INDOOR, LANDMARK_CELADON_CITY, MUSIC_GAME_CORNER_YELLOW, FALSE, PALETTE_DAY, FISHGROUP_SHORE ; K6c: Yellow MUSIC_GAME_CORNER
...
; interiors.  INDOOR, not DUNGEON: Yellow's ROCKET HIDEOUT has no wild table.
	map RocketHideoutB1F, TILESET_KANTO_FACILITY, INDOOR, LANDMARK_CELADON_CITY, MUSIC_DUNGEON1, FALSE, PALETTE_DAY, FISHGROUP_SHORE ; K6c: Yellow MUSIC_DUNGEON1
	map RocketHideoutB2F, TILESET_KANTO_FACILITY, INDOOR, LANDMARK_CELADON_CITY, MUSIC_DUNGEON1, FALSE, PALETTE_DAY, FISHGROUP_SHORE ; K6c: Yellow MUSIC_DUNGEON1
	map RocketHideoutB3F, TILESET_KANTO_FACILITY, INDOOR, LANDMARK_CELADON_CITY, MUSIC_DUNGEON1, FALSE, PALETTE_DAY, FISHGROUP_SHORE ; K6c: Yellow MUSIC_DUNGEON1
	map RocketHideoutB4F, TILESET_KANTO_FACILITY, INDOOR, LANDMARK_CELADON_CITY, MUSIC_DUNGEON1, FALSE, PALETTE_DAY, FISHGROUP_SHORE ; K6c: Yellow MUSIC_DUNGEON1
	map RocketHideoutElevator, TILESET_MART, INDOOR, LANDMARK_CELADON_CITY, MUSIC_DUNGEON1, FALSE, PALETTE_DAY, FISHGROUP_SHORE ; K6c: Yellow MUSIC_DUNGEON1
...
MapGroup_Cianwood:
	table_width MAP_LENGTH
	map Route40, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_40, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_SHORE_L78
	map Route41, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_41, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN_L78
	map CianwoodCity, TILESET_JOHTO, TOWN, LANDMARK_CIANWOOD_CITY, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE_L78
...
MapGroup_Viridian:
	...
	map VictoryRoadGate, TILESET_GATE, GATE, LANDMARK_ROUTE_26, MUSIC_DUNGEON2, FALSE, PALETTE_DAY, FISHGROUP_SHORE ; K6c: Yellow's ROUTE_22_GATE plays MUSIC_DUNGEON2 (shared with the Johto walk-out)
	map ViridianForest, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_2, MUSIC_DUNGEON2, FALSE, PALETTE_AUTO, FISHGROUP_SHORE ; K6c: Yellow MUSIC_DUNGEON2
	...
	map DiglettsCaveRoute2, TILESET_KANTO_CAVE, CAVE, LANDMARK_DIGLETTS_CAVE, MUSIC_DUNGEON2, TRUE, PALETTE_NITE, FISHGROUP_SHORE ; Kanto hack (docs/M4-VERMILION.md, 7c); K6c: Yellow MUSIC_DUNGEON2
	assert_table_length NUM_VIRIDIAN_MAPS

MapGroup_NewBark:
	table_width MAP_LENGTH
	map Route26, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_26, MUSIC_ROUTE_26, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN_L58
	map Route27, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_27, MUSIC_ROUTE_26, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN_L58
...
; Kanto hack (M8 11a): Silph Co. 2F-11F + the elevator.
	...
	map SaffronMagnetTrainStation, TILESET_TRAIN_STATION, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE ; Kanto hack (M11 14h, D146): Crystal's station, back for the Johto act (its door only exists once ENGINE_POKEGEAR is set)
