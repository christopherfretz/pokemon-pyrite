...
MapGroup_Dungeons:
	...
	map VictoryRoad1F, TILESET_CAVE, CAVE, LANDMARK_VICTORY_ROAD, MUSIC_VICTORY_ROAD, TRUE, PALETTE_NITE, FISHGROUP_NONE ; Kanto hack (M10 13f): Yellow's VICTORY ROAD 1F; no water on any VR floor, so FISHGROUP_NONE
...
MapGroup_Indigo:
	...
	map BrunosRoom, TILESET_KANTO_E4, INDOOR, LANDMARK_INDIGO_PLATEAU, MUSIC_INDIGO_PLATEAU, FALSE, PALETTE_DAY, FISHGROUP_NONE ; Kanto hack (M10 13j): Yellow's 5x6 on GYM; Yellow's DUNGEON1 -> MUSIC_INDIGO_PLATEAU stand-in (D131, K6); no phone (Gen 2)
	...
	map LancesRoom, TILESET_KANTO_E4, INDOOR, LANDMARK_INDIGO_PLATEAU, MUSIC_INDIGO_PLATEAU, FALSE, PALETTE_DAY, FISHGROUP_NONE ; Kanto hack (M10 13j): Yellow's 13x13 on GYM; Yellow's DUNGEON1 -> MUSIC_INDIGO_PLATEAU stand-in (D131, K6); no phone (Gen 2)
