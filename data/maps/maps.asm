...
MapGroup_Dungeons:
	...
	map SafariZoneFuchsiaGateBeta, TILESET_GATE, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE ; Kanto hack (M7 10n): unused beta map, but FISHGROUP_SHORE is a CORSOLA leak in waiting
...
MapGroup_Cinnabar:
	...
	map Route19FuchsiaGate, TILESET_KANTO_GATE, GATE, LANDMARK_ROUTE_19, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Fuchsia:
	...
	map Route15FuchsiaGate, TILESET_KANTO_GATE, GATE, LANDMARK_ROUTE_15, MUSIC_ROUTE_12, FALSE, PALETTE_DAY, FISHGROUP_NONE ; Kanto hack (M7 10n): a gate interior, as Route15Gate2F below
...
; FISHGROUP_NONE; the areas take Yellow's own super-rod rows.
	map Route15Gate2F, TILESET_KANTO_GATE, GATE, LANDMARK_ROUTE_15, MUSIC_ROUTE_12, FALSE, PALETTE_DAY, FISHGROUP_NONE
