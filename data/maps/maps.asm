...
MapGroup_Dungeons:
	...
	map DiglettsCave, TILESET_CAVE, CAVE, LANDMARK_DIGLETTS_CAVE, MUSIC_DUNGEON2, TRUE, PALETTE_NITE, FISHGROUP_SHORE ; K6c: Yellow MUSIC_DUNGEON2
	...
	map RockTunnel1F, TILESET_DARK_CAVE, CAVE, LANDMARK_ROCK_TUNNEL, MUSIC_DUNGEON3, TRUE, PALETTE_DARK, FISHGROUP_SHORE ; K6c: Yellow MUSIC_DUNGEON3
	map RockTunnelB1F, TILESET_DARK_CAVE, CAVE, LANDMARK_ROCK_TUNNEL, MUSIC_DUNGEON3, TRUE, PALETTE_DARK, FISHGROUP_SHORE ; K6c: Yellow MUSIC_DUNGEON3
	...
	map VictoryRoad1F, TILESET_CAVE, CAVE, LANDMARK_VICTORY_ROAD, MUSIC_DUNGEON3, TRUE, PALETTE_NITE, FISHGROUP_NONE ; Kanto hack (M10 13f): Yellow's VICTORY ROAD 1F; no water on any VR floor, so FISHGROUP_NONE; K6c: Yellow MUSIC_DUNGEON3
	map MtMoon1F, TILESET_CAVE, CAVE, LANDMARK_MT_MOON, MUSIC_DUNGEON3, TRUE, PALETTE_NITE, FISHGROUP_SHORE ; K6c: Yellow MUSIC_DUNGEON3
	map MtMoonB1F, TILESET_CAVE, CAVE, LANDMARK_MT_MOON, MUSIC_DUNGEON3, TRUE, PALETTE_NITE, FISHGROUP_SHORE ; K6c: Yellow MUSIC_DUNGEON3
	map MtMoonB2F, TILESET_CAVE, CAVE, LANDMARK_MT_MOON, MUSIC_DUNGEON3, TRUE, PALETTE_NITE, FISHGROUP_SHORE ; K6c: Yellow MUSIC_DUNGEON3
	...
	map VictoryRoad2F, TILESET_CAVE, CAVE, LANDMARK_VICTORY_ROAD, MUSIC_DUNGEON3, TRUE, PALETTE_NITE, FISHGROUP_NONE ; Kanto hack (M10 13f); K6c: Yellow MUSIC_DUNGEON3
	map VictoryRoad3F, TILESET_CAVE, CAVE, LANDMARK_VICTORY_ROAD, MUSIC_DUNGEON3, TRUE, PALETTE_NITE, FISHGROUP_NONE ; Kanto hack (M10 13f); K6c: Yellow MUSIC_DUNGEON3
...
; encounters -- PokemonTower3F-7F is the precedent.
	map SeafoamIslands1F, TILESET_CAVE, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_DUNGEON2, TRUE, PALETTE_NITE, FISHGROUP_NONE ; K6c: Yellow MUSIC_DUNGEON2
	map SeafoamIslandsB1F, TILESET_CAVE, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_DUNGEON2, TRUE, PALETTE_NITE, FISHGROUP_NONE ; K6c: Yellow MUSIC_DUNGEON2
	map SeafoamIslandsB2F, TILESET_CAVE, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_DUNGEON2, TRUE, PALETTE_NITE, FISHGROUP_NONE ; K6c: Yellow MUSIC_DUNGEON2
	map SeafoamIslandsB3F, TILESET_CAVE, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_DUNGEON2, TRUE, PALETTE_NITE, FISHGROUP_KANTO_SEAFOAM ; Kanto hack (M9 12o): Yellow's B3F/B4F row (D102); K6c: Yellow MUSIC_DUNGEON2
	map SeafoamIslandsB4F, TILESET_CAVE, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_DUNGEON2, TRUE, PALETTE_NITE, FISHGROUP_KANTO_SEAFOAM ; Kanto hack (M9 12o): Yellow's B3F/B4F row (D102); K6c: Yellow MUSIC_DUNGEON2
...
MapGroup_Vermilion:
	...
	map DiglettsCaveRoute11, TILESET_CAVE, CAVE, LANDMARK_DIGLETTS_CAVE, MUSIC_DUNGEON2, TRUE, PALETTE_NITE, FISHGROUP_SHORE ; Kanto hack (docs/M4-VERMILION.md, 7c); K6c: Yellow MUSIC_DUNGEON2
...
MapGroup_Viridian:
	...
	map DiglettsCaveRoute2, TILESET_CAVE, CAVE, LANDMARK_DIGLETTS_CAVE, MUSIC_DUNGEON2, TRUE, PALETTE_NITE, FISHGROUP_SHORE ; Kanto hack (docs/M4-VERMILION.md, 7c); K6c: Yellow MUSIC_DUNGEON2
