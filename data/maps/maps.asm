...
MapGroup_Vermilion:
	...
	map Route11Gate1F, TILESET_GATE, GATE, LANDMARK_ROUTE_11, MUSIC_VERMILION_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE ; Kanto hack (docs/M4-VERMILION.md, 7c)
	map Route11Gate2F, TILESET_GATE, GATE, LANDMARK_ROUTE_11, MUSIC_VERMILION_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE ; Kanto hack (docs/M4-VERMILION.md, 7c)
...
MapGroup_Pewter:
	...
	map Museum1F, TILESET_GATE, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Museum2F, TILESET_GATE, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
