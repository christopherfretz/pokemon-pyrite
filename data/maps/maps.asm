...
MapGroup_Vermilion:
	...
	map Route6SaffronGate, TILESET_KANTO_GATE, GATE, LANDMARK_ROUTE_6, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE ; Kanto hack (M4 audit): Yellow gives every Kanto gate MUSIC_CITIES1, the town theme (vendor/pokeyellow/data/maps/songs.asm) -- our Kanto-town stand-in, matching Route5SaffronGate
...
MapGroup_Lavender:
	...
	map Route8SaffronGate, TILESET_KANTO_GATE, GATE, LANDMARK_ROUTE_8, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE ; Kanto hack (M5 8j): Yellow plays MUSIC_CITIES1 (== our MUSIC_VIRIDIAN_CITY) inside every gate hut, not the route theme
...
MapGroup_Celadon:
	...
	map Route7SaffronGate, TILESET_KANTO_GATE, GATE, LANDMARK_ROUTE_7, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE ; Kanto hack (M5 8k): Yellow plays MUSIC_CITIES1 (== our MUSIC_VIRIDIAN_CITY) inside every gate hut, not the route theme
...
MapGroup_Saffron:
	...
	map Route5UndergroundPathEntrance, TILESET_KANTO_GATE, GATE, LANDMARK_ROUTE_5, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE ; Kanto hack (M4 audit): Yellow gives every Kanto gate MUSIC_CITIES1, the town theme (vendor/pokeyellow/data/maps/songs.asm) -- our Kanto-town stand-in, matching Route5SaffronGate
	map Route5SaffronGate, TILESET_KANTO_GATE, GATE, LANDMARK_ROUTE_5, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route5DayCare, TILESET_HOUSE, INDOOR, LANDMARK_ROUTE_5, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE ; Kanto hack (docs/M4-VERMILION.md, decision (c))
