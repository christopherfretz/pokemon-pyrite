...
; Crystal-tileset rooms take the ordinary indoor $00.
	...
	map_attributes LoreleisRoom, LORELEIS_ROOM, $03 ; Kanto hack (M10 13j): Yellow's `db $3 ; border block`
...
; connections -- the Tower is reached only by its warps.
	...
	map_attributes ViridianGym, VIRIDIAN_GYM, $03 ; Kanto hack (M10 13a): Yellow's border block
