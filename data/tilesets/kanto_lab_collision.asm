; TILESET_KANTO_LAB -- generated by scripts/kanto_lab_blk.py from
; Yellow's lab blockset and its Lab_Coll whitelist.  Do not hand-edit:
; `scripts/kanto_lab_blk.py --check` diffs it against the source.  Warp
; overrides live in that script's WARPS.
	tilecoll WALL, WALL, WALL, WALL ; 00  ; unusable in GSC; no LAB map we ship uses block $00
	...
	tilecoll FLOOR, FLOOR, WARP_CARPET_DOWN, WARP_CARPET_DOWN ; 0c  ; warp override: the south exit mat (all four LAB maps)
	...
	tilecoll DOOR, WALL, FLOOR, FLOOR ; 18  ; warp override: the hall's three doors, tile $34
