; TILESET_KANTO_TOWER -- generated by scripts/lavender_blk.py from
; Yellow's cemetery blockset and its Cemetery_Coll whitelist.  Do not
; hand-edit: `scripts/lavender_blk.py --check` diffs it against the source.
	tilecoll WALL, WALL, WALL, WALL ; 00  ; unusable in GSC, but no tower map uses block $00
	...
	tilecoll WALL, FLOOR, WALL, LADDER ; 11  ; staircase
	tilecoll FLOOR, WALL, LADDER, WALL ; 12  ; staircase
	tilecoll FLOOR, FLOOR, FLOOR, WALL ; 13
	tilecoll WALL, WALL, WALL, WALL ; 14
	tilecoll WALL, FLOOR, WALL, LADDER ; 15  ; staircase
	tilecoll FLOOR, WALL, LADDER, WALL ; 16  ; staircase
	...
	tilecoll COUNTER, WALL, FLOOR, WALL ; 23
	...
	tilecoll WALL, LADDER, WALL, WALL ; 30  ; staircase
	tilecoll WALL, LADDER, WALL, WALL ; 31  ; staircase
