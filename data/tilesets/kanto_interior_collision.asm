; TILESET_KANTO_INTERIOR -- generated by scripts/kanto_interior_blk.py
; from Yellow's interior blockset and its Interior_Coll whitelist.  Do not
; hand-edit: `scripts/kanto_interior_blk.py --check` diffs it against the
; source.  Warp overrides live in that script's WARPS.
	tilecoll WALL, WALL, WALL, WALL ; 00  ; unusable in GSC; no INTERIOR map we ship uses block $00
	...
	tilecoll WALL, DOOR, FLOOR, FLOOR ; 1d  ; warp override
	tilecoll WALL, DOOR, FLOOR, FLOOR ; 1e  ; warp override
	...
	tilecoll FLOOR, WARP_PANEL, FLOOR, FLOOR ; 39  ; warp override
