...
; Kanto hack (M6 9u/9v): the GAME CORNER's hideout staircase and the two
; halves of its door mat, then the PRIZE ROOM's back wall and counter.
; Generated by scripts/celadon_blk.py.
	tilecoll WALL, STAIRCASE, FLOOR, FLOOR ; 41  yellow $43, stairs down to ROCKET HIDEOUT B1F
	tilecoll FLOOR, FLOOR, FLOOR, WARP_CARPET_DOWN ; 42  yellow $28, door mat BR
	tilecoll FLOOR, FLOOR, WARP_CARPET_DOWN, FLOOR ; 43  yellow $29, door mat BL
	tilecoll WALL, WALL, WALL, WALL ; 44  yellow $3f, prize room back wall
	tilecoll WALL, WALL, WALL, WALL ; 45  yellow $40, back wall with a prize window
	tilecoll COUNTER, COUNTER, FLOOR, FLOOR ; 46  yellow $3e, prize counter over floor
