; TILESET_KANTO_PLATEAU -- generated by scripts/kanto_plateau_blk.py
; from Yellow's plateau blockset and its Plateau_Coll whitelist.  Do not
; hand-edit: `scripts/kanto_plateau_blk.py --check` diffs it.
