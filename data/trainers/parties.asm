...
; outgrows evolves in place (D143). Moves are Crystal's.
FalknerGroup:
	; FALKNER (1)
	db "FALKNER@", TRAINERTYPE_MOVES
	db 57, PIDGEOT,    TACKLE, MUD_SLAP, NO_MOVE, NO_MOVE
	db 60, PIDGEOT,    TACKLE, MUD_SLAP, GUST, NO_MOVE
	db -1 ; end

WhitneyGroup:
	; WHITNEY (1)
	db "WHITNEY@", TRAINERTYPE_MOVES
	db 66, CLEFAIRY,   DOUBLESLAP, MIMIC, ENCORE, METRONOME
	db 68, MILTANK,    ROLLOUT, ATTRACT, STOMP, MILK_DRINK
	db -1 ; end

BugsyGroup:
	; BUGSY (1)
	db "BUGSY@", TRAINERTYPE_MOVES
	db 62, BUTTERFREE, TACKLE, STRING_SHOT, HARDEN, NO_MOVE
	db 62, BEEDRILL,   POISON_STING, STRING_SHOT, HARDEN, NO_MOVE
	db 64, SCYTHER,    QUICK_ATTACK, LEER, FURY_CUTTER, NO_MOVE
	db -1 ; end
...
MortyGroup:
	...
	db 70, HAUNTER,    HYPNOSIS, MIMIC, CURSE, NIGHT_SHADE
	db 73, GENGAR,     HYPNOSIS, SHADOW_BALL, MEAN_LOOK, DREAM_EATER
	db 72, HAUNTER,    SPITE, MEAN_LOOK, MIMIC, NIGHT_SHADE
	db -1 ; end

PryceGroup:
	; PRYCE (1)
	db "PRYCE@", TRAINERTYPE_MOVES
	db 81, DEWGONG,    HEADBUTT, ICY_WIND, AURORA_BEAM, REST
	db 83, DEWGONG,    HEADBUTT, ICY_WIND, AURORA_BEAM, REST
	db 85, PILOSWINE,  ICY_WIND, FURY_ATTACK, MIST, BLIZZARD
	db -1 ; end

JasmineGroup:
	; JASMINE (1)
	db "JASMINE@", TRAINERTYPE_MOVES
	db 78, MAGNETON,   THUNDERBOLT, SUPERSONIC, SONICBOOM, THUNDER_WAVE
	db 78, MAGNETON,   THUNDERBOLT, SUPERSONIC, SONICBOOM, THUNDER_WAVE
	db 81, STEELIX,    SCREECH, SUNNY_DAY, ROCK_THROW, IRON_TAIL
	db -1 ; end
...
ChuckGroup:
	...
	db 77, POLIWRATH,  HYPNOSIS, MIND_READER, SURF, DYNAMICPUNCH
	db -1 ; end

ClairGroup:
	; CLAIR (1)
	db "CLAIR@", TRAINERTYPE_MOVES
	db 87, DRAGONITE,  THUNDER_WAVE, SURF, SLAM, DRAGONBREATH
	db 87, DRAGONITE,  THUNDER_WAVE, THUNDERBOLT, SLAM, DRAGONBREATH
	db 87, DRAGONITE,  THUNDER_WAVE, ICE_BEAM, SLAM, DRAGONBREATH
	db 90, KINGDRA,    SMOKESCREEN, SURF, HYPER_BEAM, DRAGONBREATH
	db -1 ; end
