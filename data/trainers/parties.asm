...
; Kanto hack (M11 14d, D143/D144): Johto gym leaders rescaled to the post-E4
; curve (docs/M11-JOHTO.md level-rescale table); a pre-evolution the new level
; outgrows evolves in place (D143).
; JG1 (operator 2026-09-25, "every gym leader should feel like a final boss"):
; six type-themed Pokemon each, band ace-5 .. ace (14d's ace, sent out last),
; TRAINERTYPE_ITEM_MOVES with the best legal Gen 2 sets (level-up incl.
; pre-evolutions, TM/HM, tutor; no egg moves) and Crystal-style held items.
; scripts/johto_gym_legality.py checks every row.
FalknerGroup:
	; FALKNER (1)
	db "FALKNER@", TRAINERTYPE_ITEM_MOVES
	db 55, NOCTOWL,    LEFTOVERS,    HYPNOSIS, DREAM_EATER, REFLECT, STEEL_WING
	db 56, XATU,       BRIGHTPOWDER, PSYCHIC_M, NIGHT_SHADE, CONFUSE_RAY, GIGA_DRAIN
	db 57, PIDGEOT,    GOLD_BERRY,   WING_ATTACK, DOUBLE_EDGE, SAND_ATTACK, STEEL_WING
	db 57, FEAROW,     SHARP_BEAK,   DRILL_PECK, DOUBLE_EDGE, PURSUIT, AGILITY
	db 58, DODRIO,     QUICK_CLAW,   DRILL_PECK, TRI_ATTACK, BODY_SLAM, AGILITY
	db 60, PIDGEOT,    SHARP_BEAK,   FLY, HYPER_BEAM, MUD_SLAP, QUICK_ATTACK
	db -1 ; end

WhitneyGroup:
	; WHITNEY (1)
	db "WHITNEY@", TRAINERTYPE_ITEM_MOVES
	db 63, CLEFABLE,   GOLD_BERRY,   BODY_SLAM, ICE_BEAM, THUNDER_WAVE, MOONLIGHT
	db 64, GIRAFARIG,  TWISTEDSPOON, PSYCHIC_M, CRUNCH, THUNDERBOLT, AGILITY
	db 65, WIGGLYTUFF, MIRACLEBERRY, SING, DOUBLE_EDGE, FLAMETHROWER, THUNDERBOLT
	db 66, TAUROS,     PINK_BOW,     BODY_SLAM, EARTHQUAKE, BLIZZARD, HYPER_BEAM
	db 67, URSARING,   SCOPE_LENS,   SLASH, EARTHQUAKE, FIRE_PUNCH, ICE_PUNCH
	db 68, MILTANK,    LEFTOVERS,    ROLLOUT, BODY_SLAM, MILK_DRINK, ATTRACT
	db -1 ; end

BugsyGroup:
	; BUGSY (1)
	db "BUGSY@", TRAINERTYPE_ITEM_MOVES
	db 59, BUTTERFREE, BRIGHTPOWDER, SLEEP_POWDER, PSYCHIC_M, GIGA_DRAIN, STUN_SPORE
	db 60, LEDIAN,     LEFTOVERS,    REFLECT, LIGHT_SCREEN, ICE_PUNCH, THUNDERPUNCH
	db 61, BEEDRILL,   KINGS_ROCK,   TWINEEDLE, SLUDGE_BOMB, SWORDS_DANCE, AGILITY
	db 62, PINSIR,     QUICK_CLAW,   SUBMISSION, BODY_SLAM, GUILLOTINE, SWORDS_DANCE
	db 63, HERACROSS,  FOCUS_BAND,   MEGAHORN, EARTHQUAKE, REVERSAL, ENDURE
	db 64, SCYTHER,    SILVERPOWDER, FURY_CUTTER, WING_ATTACK, SLASH, SWORDS_DANCE
	db -1 ; end

MortyGroup:
	; MORTY (1)
	db "MORTY@", TRAINERTYPE_ITEM_MOVES
	db 68, MISDREAVUS, MIRACLEBERRY, MEAN_LOOK, PERISH_SONG, PAIN_SPLIT, SHADOW_BALL
	db 69, HAUNTER,    SPELL_TAG,    SHADOW_BALL, HYPNOSIS, DREAM_EATER, DESTINY_BOND
	db 70, GENGAR,     QUICK_CLAW,   FIRE_PUNCH, THUNDERPUNCH, GIGA_DRAIN, EXPLOSION
	db 71, HAUNTER,    LEFTOVERS,    MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 72, GENGAR,     BRIGHTPOWDER, HYPNOSIS, NIGHTMARE, DREAM_EATER, SHADOW_BALL
	db 73, GENGAR,     SPELL_TAG,    SHADOW_BALL, THUNDERBOLT, ICE_PUNCH, HYPNOSIS
	db -1 ; end

PryceGroup:
	; PRYCE (1)
	db "PRYCE@", TRAINERTYPE_ITEM_MOVES
	db 80, JYNX,       NEVERMELTICE, LOVELY_KISS, ICE_BEAM, PSYCHIC_M, DREAM_EATER
	db 81, DEWGONG,    MINT_BERRY,   ICE_BEAM, SURF, TOXIC, REST
	db 82, CLOYSTER,   KINGS_ROCK,   SPIKE_CANNON, ICE_BEAM, SPIKES, EXPLOSION
	db 83, DEWGONG,    QUICK_CLAW,   BLIZZARD, SURF, HORN_DRILL, BODY_SLAM
	db 84, LAPRAS,     GOLD_BERRY,   SURF, ICE_BEAM, THUNDERBOLT, CONFUSE_RAY
	db 85, PILOSWINE,  LEFTOVERS,    EARTHQUAKE, BLIZZARD, AMNESIA, REST
	db -1 ; end

JasmineGroup:
	; JASMINE (1)
	db "JASMINE@", TRAINERTYPE_ITEM_MOVES
	db 76, MAGNETON,   MAGNET,       THUNDERBOLT, THUNDER_WAVE, TRI_ATTACK, REFLECT
	db 77, MAGNETON,   QUICK_CLAW,   LOCK_ON, ZAP_CANNON, RAIN_DANCE, THUNDER
	db 78, FORRETRESS, LEFTOVERS,    SPIKES, TOXIC, EXPLOSION, DOUBLE_EDGE
	db 79, SKARMORY,   BRIGHTPOWDER, STEEL_WING, FLY, TOXIC, REST
	db 80, SCIZOR,     METAL_COAT,   STEEL_WING, SLASH, FURY_CUTTER, SWORDS_DANCE
	db 81, STEELIX,    METAL_COAT,   IRON_TAIL, EARTHQUAKE, ROCK_SLIDE, CRUNCH
	db -1 ; end

ChuckGroup:
	; CHUCK (1)
	db "CHUCK@", TRAINERTYPE_ITEM_MOVES
	db 72, HITMONTOP,  KINGS_ROCK,   TRIPLE_KICK, DIG, PURSUIT, COUNTER
	db 73, HITMONCHAN, QUICK_CLAW,   MACH_PUNCH, FIRE_PUNCH, ICE_PUNCH, THUNDERPUNCH
	db 74, HITMONLEE,  FOCUS_BAND,   HI_JUMP_KICK, MIND_READER, BODY_SLAM, REVERSAL
	db 75, PRIMEAPE,   SCOPE_LENS,   CROSS_CHOP, ROCK_SLIDE, THUNDERPUNCH, SCREECH
	db 76, MACHAMP,    BLACKBELT_I,  CROSS_CHOP, EARTHQUAKE, ROCK_SLIDE, FIRE_BLAST
	db 77, POLIWRATH,  LEFTOVERS,    MIND_READER, DYNAMICPUNCH, SURF, ICE_BEAM
	db -1 ; end

ClairGroup:
	; CLAIR (1)
	db "CLAIR@", TRAINERTYPE_ITEM_MOVES
	db 85, GYARADOS,   MYSTIC_WATER, SURF, BODY_SLAM, THUNDERBOLT, DRAGONBREATH
	db 86, CHARIZARD,  CHARCOAL,     FLAMETHROWER, DRAGONBREATH, EARTHQUAKE, SLASH
	db 87, DRAGONITE,  LEFTOVERS,    THUNDER_WAVE, DRAGONBREATH, THUNDERBOLT, REFLECT
	db 88, AERODACTYL, HARD_STONE,   ANCIENTPOWER, EARTHQUAKE, BITE, AGILITY
	db 89, DRAGONITE,  QUICK_CLAW,   OUTRAGE, FLAMETHROWER, ICE_BEAM, HYPER_BEAM
	db 90, KINGDRA,    DRAGON_SCALE, SURF, DRAGONBREATH, ICE_BEAM, HYPER_BEAM
	db -1 ; end

; Kanto hack (M11 14d, D143/D144): SILVER rows 1-12 rescaled (Cherrygrove 58,
; Azalea 62-66, Burned Tower 68-72, Underground 76-80), evolved in place.
; Rows 13-15 (Crystal's Victory Road fight) are unused and untouched.
Rival1Group:
	; RIVAL1 (1)
	...
	db 70, HAUNTER,    LICK, SPITE, MEAN_LOOK, CURSE
	db 68, MAGNETON,   TACKLE, THUNDERSHOCK, SUPERSONIC, SONICBOOM
	db 70, GOLBAT,     LEECH_LIFE, SUPERSONIC, BITE, CONFUSE_RAY
	db 72, MEGANIUM,   GROWL, REFLECT, RAZOR_LEAF, POISONPOWDER
	db -1 ; end
	...
	db 68, MAGNETON,   TACKLE, THUNDERSHOCK, SUPERSONIC, SONICBOOM
	db 70, GOLBAT,     LEECH_LIFE, SUPERSONIC, BITE, CONFUSE_RAY
	db 72, TYPHLOSION, LEER, SMOKESCREEN, EMBER, QUICK_ATTACK
	db -1 ; end
	...
	db 68, MAGNETON,   TACKLE, THUNDERSHOCK, SUPERSONIC, SONICBOOM
	db 70, GOLBAT,     LEECH_LIFE, SUPERSONIC, BITE, CONFUSE_RAY
	db 72, FERALIGATR, LEER, RAGE, WATER_GUN, BITE
	db -1 ; end

	; RIVAL1 (10)
	db "?@", TRAINERTYPE_MOVES
	db 78, GOLBAT,     LEECH_LIFE, BITE, CONFUSE_RAY, WING_ATTACK
	db 76, MAGNETON,   TACKLE, THUNDERSHOCK, SONICBOOM, THUNDER_WAVE
	db 78, HAUNTER,    LICK, MEAN_LOOK, CURSE, SHADOW_BALL
	db 80, SNEASEL,    LEER, QUICK_ATTACK, SCREECH, FAINT_ATTACK
	db 80, MEGANIUM,   REFLECT, RAZOR_LEAF, POISONPOWDER, BODY_SLAM
	db -1 ; end
	...
	db 78, HAUNTER,    LICK, MEAN_LOOK, CURSE, SHADOW_BALL
	db 80, SNEASEL,    LEER, QUICK_ATTACK, SCREECH, FAINT_ATTACK
	db 80, TYPHLOSION, SMOKESCREEN, EMBER, QUICK_ATTACK, FLAME_WHEEL
	db -1 ; end
	...
	db 78, HAUNTER,    LICK, MEAN_LOOK, CURSE, SHADOW_BALL
	db 80, SNEASEL,    LEER, QUICK_ATTACK, SCREECH, FAINT_ATTACK
	db 80, FERALIGATR, RAGE, WATER_GUN, BITE, SCARY_FACE
	db -1 ; end
...
; Kanto hack (M11 14d/14j, D154): LANCE (Mt. Silver): 14d levels, 14j's best legal Gen 2 sets.
ChampionGroup:
	; CHAMPION (1)
	db "LANCE@", TRAINERTYPE_MOVES
	db 95, GYARADOS,   HYDRO_PUMP, THUNDER, RAIN_DANCE, HYPER_BEAM
	db 97, DRAGONITE,  DRAGONBREATH, THUNDERBOLT, THUNDER_WAVE, HYPER_BEAM
	db 97, DRAGONITE,  OUTRAGE, ICE_BEAM, SURF, HYPER_BEAM
	db 96, AERODACTYL, ANCIENTPOWER, EARTHQUAKE, WING_ATTACK, HYPER_BEAM
	db 96, CHARIZARD,  FIRE_BLAST, EARTHQUAKE, WING_ATTACK, SLASH
	db 100, DRAGONITE,  OUTRAGE, FIRE_BLAST, BLIZZARD, HYPER_BEAM
	db -1 ; end
...
ScientistGroup:
	...
	db 80, PORYGON,    CONVERSION, CONVERSION2, RECOVER, TRI_ATTACK
	db -1 ; end
...
YoungsterGroup:
	...
	db 71, RATICATE,   TAIL_WHIP, QUICK_ATTACK, HYPER_FANG, SCARY_FACE
	db -1 ; end
	...
	; YOUNGSTER (14)
	db "JOEY@", TRAINERTYPE_MOVES
	db 87, RATICATE,   HYPER_BEAM, QUICK_ATTACK, HYPER_FANG, PURSUIT
	db -1 ; end
...
SchoolboyGroup:
	...
	db 85, ELECTRODE,  SCREECH, SONICBOOM, ROLLOUT, LIGHT_SCREEN
	db 85, GROWLITHE,  SUNNY_DAY, LEER, TAKE_DOWN, FLAME_WHEEL
	db 87, VILEPLUME,  SOLARBEAM, SLEEP_POWDER, ACID, MOONLIGHT
	db -1 ; end
	...
	db 85, XATU,       PECK, NIGHT_SHADE, SWIFT, FUTURE_SIGHT
	db 82, TANGELA,    POISONPOWDER, VINE_WHIP, BIND, MEGA_DRAIN
	db 82, YANMA,      QUICK_ATTACK, DOUBLE_TEAM, SONICBOOM, SUPERSONIC
	db 85, QUAGSIRE,   TAIL_WHIP, SLAM, AMNESIA, EARTHQUAKE
	db -1 ; end
	...
	db 88, MAGNETON,   ZAP_CANNON, THUNDER_WAVE, LOCK_ON, SWIFT
	db -1 ; end
...
BirdKeeperGroup:
	...
	; BIRD_KEEPER (12) -- Kanto hack (M11 14a, D145): Route 26/27 entry band, Crystal Lv30-43 mapped linearly onto Lv55-62
	...
	; BIRD_KEEPER (14) -- Kanto hack (M11 14a, D145): Route 26/27 entry band, Crystal Lv30-43 mapped linearly onto Lv55-62
	db "JOSE@", TRAINERTYPE_NORMAL
	db 57, FARFETCH_D
	db -1 ; end
	...
	; BIRD_KEEPER (17) -- Kanto hack (M11 14a, D145): Route 26/27 entry band, Crystal Lv30-43 mapped linearly onto Lv55-62
	...
	db 88, PIDGEOT,    TOXIC, QUICK_ATTACK, WHIRLWIND, FLY
...
LassGroup:
	...
	db 68, GRANBULL,   SCARY_FACE, CHARM, BITE, LICK
	db -1 ; end
	...
	db 68, AMPHAROS,   TACKLE, GROWL, THUNDERSHOCK, THUNDER_WAVE
	db 68, GOLDUCK,    SCRATCH, TAIL_WHIP, DISABLE, CONFUSION
	db -1 ; end
	...
	; LASS (14)
	db "DANA@", TRAINERTYPE_MOVES
	db 71, AMPHAROS,   TACKLE, GROWL, THUNDERSHOCK, THUNDER_WAVE
	db 71, GOLDUCK,    SCRATCH, TAIL_WHIP, DISABLE, CONFUSION
	db -1 ; end

	; LASS (15)
	db "DANA@", TRAINERTYPE_MOVES
	db 79, GOLDUCK,    SCRATCH, DISABLE, CONFUSION, SCREECH
	db 79, AMPHAROS,   TACKLE, THUNDERSHOCK, THUNDER_WAVE, COTTON_SPORE
	db -1 ; end

	; LASS (16)
	db "DANA@", TRAINERTYPE_MOVES
	db 82, GOLDUCK,    SCRATCH, DISABLE, CONFUSION, SCREECH
	db 82, AMPHAROS,   TACKLE, THUNDERPUNCH, THUNDER_WAVE, COTTON_SPORE
	db -1 ; end

	; LASS (17)
	db "DANA@", TRAINERTYPE_MOVES
	db 86, AMPHAROS,   SWIFT, THUNDERPUNCH, THUNDER_WAVE, COTTON_SPORE
	db 86, GOLDUCK,    DISABLE, SURF, PSYCHIC_M, SCREECH
	db -1 ; end
...
CooltrainerMGroup:
	...
	db 76, CHARIZARD,  EMBER, SMOKESCREEN, RAGE, SCARY_FACE
	db 76, BLASTOISE,  WITHDRAW, WATER_GUN, BITE, CURSE
	db 76, VENUSAUR,   LEECH_SEED, POISONPOWDER, SLEEP_POWDER, RAZOR_LEAF
	db -1 ; end
	...
	; COOLTRAINERM (6) -- Kanto hack (M11 14a, D145): Route 26/27 entry band, Crystal Lv30-43 mapped linearly onto Lv55-62
	db "GAVEN@", TRAINERTYPE_MOVES
	db 58, VICTREEBEL, WRAP, TOXIC, ACID, RAZOR_LEAF
	db 58, KINGLER,    BUBBLEBEAM, STOMP, GUILLOTINE, PROTECT
	db 58, FLAREON,    SAND_ATTACK, QUICK_ATTACK, BITE, FIRE_SPIN
	db -1 ; end

	; COOLTRAINERM (7) -- Kanto hack (M11 14a, D145): Route 26/27 entry band, Crystal Lv30-43 mapped linearly onto Lv55-62
	db "GAVEN@", TRAINERTYPE_ITEM_MOVES
	db 60, VICTREEBEL, NO_ITEM,      GIGA_DRAIN, TOXIC, SLUDGE_BOMB, RAZOR_LEAF
	db 60, KINGLER,    KINGS_ROCK,   SURF, STOMP, GUILLOTINE, BLIZZARD
	db 60, FLAREON,    NO_ITEM,      FLAMETHROWER, QUICK_ATTACK, BITE, FIRE_SPIN
	db -1 ; end

	; COOLTRAINERM (8)
	db "RYAN@", TRAINERTYPE_MOVES
	db 75, PIDGEOT,    SAND_ATTACK, QUICK_ATTACK, WHIRLWIND, WING_ATTACK
	db 77, ELECTABUZZ, THUNDERPUNCH, LIGHT_SCREEN, SWIFT, SCREECH
	db -1 ; end

	; COOLTRAINERM (9) -- Kanto hack (M11 14a, D145): Route 26/27 entry band, Crystal Lv30-43 mapped linearly onto Lv55-62
	db "JAKE@", TRAINERTYPE_MOVES
	db 57, PARASECT,   LEECH_LIFE, SPORE, SLASH, SWORDS_DANCE
	db 58, GOLDUCK,    CONFUSION, SCREECH, PSYCH_UP, FURY_SWIPES
	db -1 ; end

	; COOLTRAINERM (10) -- Kanto hack (M11 14a, D145): Route 26/27 entry band, Crystal Lv30-43 mapped linearly onto Lv55-62
	db "GAVEN@", TRAINERTYPE_MOVES
	db 56, VICTREEBEL, WRAP, TOXIC, ACID, RAZOR_LEAF
	db 56, KINGLER,    BUBBLEBEAM, STOMP, GUILLOTINE, PROTECT
	db 56, FLAREON,    SAND_ATTACK, QUICK_ATTACK, BITE, FIRE_SPIN
	db -1 ; end

	; COOLTRAINERM (11) -- Kanto hack (M11 14a, D145): Route 26/27 entry band, Crystal Lv30-43 mapped linearly onto Lv55-62
	db "BLAKE@", TRAINERTYPE_MOVES
	db 57, MAGNETON,   THUNDERBOLT, SUPERSONIC, SWIFT, SCREECH
	db 56, QUAGSIRE,   WATER_GUN, SLAM, AMNESIA, EARTHQUAKE
	db 56, EXEGGCUTE,  LEECH_SEED, CONFUSION, SLEEP_POWDER, SOLARBEAM
	db -1 ; end

	; COOLTRAINERM (12) -- Kanto hack (M11 14a, D145): Route 26/27 entry band, Crystal Lv30-43 mapped linearly onto Lv55-62
	db "BRIAN@", TRAINERTYPE_MOVES
	db 58, SANDSLASH,  SAND_ATTACK, POISON_STING, SLASH, SWIFT
	db -1 ; end
	...
	db 77, CHARIZARD,  EMBER, SMOKESCREEN, RAGE, SCARY_FACE
	db -1 ; end

	; COOLTRAINERM (20)
	db "DARIN@", TRAINERTYPE_MOVES
	db 87, DRAGONITE,  WRAP, SURF, DRAGON_RAGE, SLAM
	db -1 ; end
...
CooltrainerFGroup:
	...
	db 75, JUMPLUFF,   SYNTHESIS, POISONPOWDER, MEGA_DRAIN, LEECH_SEED
	db 75, NINETALES,  EMBER, QUICK_ATTACK, CONFUSE_RAY, SAFEGUARD
	db -1 ; end
	...
	; COOLTRAINERF (8) -- Kanto hack (M11 14a, D145): Route 26/27 entry band, Crystal Lv30-43 mapped linearly onto Lv55-62
	db "JOYCE@", TRAINERTYPE_MOVES
	db 58, PIKACHU,    QUICK_ATTACK, DOUBLE_TEAM, THUNDERBOLT, THUNDER
	db 56, BLASTOISE,  BITE, CURSE, SURF, RAIN_DANCE
	db -1 ; end

	; COOLTRAINERF (9) -- Kanto hack (M11 14a, D145): Route 26/27 entry band, Crystal Lv30-43 mapped linearly onto Lv55-62
	db "BETH@", TRAINERTYPE_MOVES
	db 58, RAPIDASH,   STOMP, FIRE_SPIN, FURY_ATTACK, AGILITY
	db -1 ; end

	; COOLTRAINERF (10) -- Kanto hack (M11 14a, D145): Route 26/27 entry band, Crystal Lv30-43 mapped linearly onto Lv55-62
	...
	; COOLTRAINERF (11) -- Kanto hack (M11 14a, D145): Route 26/27 entry band, Crystal Lv30-43 mapped linearly onto Lv55-62
	db "MEGAN@", TRAINERTYPE_MOVES
	db 56, VENUSAUR,   GROWL, LEECH_SEED, POISONPOWDER, RAZOR_LEAF
	db 56, VENUSAUR,   GROWL, LEECH_SEED, POISONPOWDER, RAZOR_LEAF
	db 56, VENUSAUR,   BODY_SLAM, SLEEP_POWDER, RAZOR_LEAF, SWEET_SCENT
	db -1 ; end

	; COOLTRAINERF (12) -- Kanto hack (M11 14a, D145): Route 26/27 entry band, Crystal Lv30-43 mapped linearly onto Lv55-62
	db "BETH@", TRAINERTYPE_MOVES
	db 60, RAPIDASH,   STOMP, FIRE_SPIN, FURY_ATTACK, AGILITY
	db -1 ; end
	...
	db 75, BUTTERFREE, CONFUSION, SLEEP_POWDER, WHIRLWIND, GUST
	db 75, BELLOSSOM,  ABSORB, STUN_SPORE, ACID, SOLARBEAM
	db -1 ; end
	...
	; COOLTRAINERF (18) -- Kanto hack (M11 14a, D145): Route 26/27 entry band, Crystal Lv30-43 mapped linearly onto Lv55-62
	db "BETH@", TRAINERTYPE_ITEM_MOVES
	db 62, RAPIDASH,   FOCUS_BAND,   STOMP, FIRE_SPIN, FURY_ATTACK, FIRE_BLAST
	db -1 ; end

	; COOLTRAINERF (19) -- Kanto hack (M11 14a, D145): Route 26/27 entry band, Crystal Lv30-43 mapped linearly onto Lv55-62
	db "REENA@", TRAINERTYPE_NORMAL
	db 57, STARMIE
	db 58, NIDOQUEEN
	db 57, STARMIE
	...
	; COOLTRAINERF (20) -- Kanto hack (M11 14a, D145): Route 26/27 entry band, Crystal Lv30-43 mapped linearly onto Lv55-62
	db "REENA@", TRAINERTYPE_ITEM_MOVES
	db 59, STARMIE,    NO_ITEM,      DOUBLE_TEAM, PSYCHIC_M, WATERFALL, CONFUSE_RAY
	db 60, NIDOQUEEN,  PINK_BOW,     EARTHQUAKE, DOUBLE_KICK, TOXIC, BODY_SLAM
	db 59, STARMIE,    NO_ITEM,      BLIZZARD, PSYCHIC_M, WATERFALL, RECOVER
	db -1 ; end

	; COOLTRAINERF (21)
	db "CARA@", TRAINERTYPE_MOVES
	db 83, SEADRA,     SMOKESCREEN, LEER, WHIRLPOOL, TWISTER
	db 83, SEADRA,     SMOKESCREEN, LEER, WHIRLPOOL, TWISTER
	db 85, SEADRA,     SWIFT, LEER, WATERFALL, TWISTER
	db -1 ; end
...
BeautyGroup:
	...
	db 66, PERSIAN,    SCRATCH, GROWL, BITE, PAY_DAY
	db 66, PERSIAN,    SCRATCH, GROWL, BITE, SLASH
	db -1 ; end
	...
	db 67, JUMPLUFF,   SYNTHESIS, TAIL_WHIP, TACKLE, POISONPOWDER
	db 67, JUMPLUFF,   SYNTHESIS, TAIL_WHIP, TACKLE, STUN_SPORE
	db -1 ; end
...
PokemaniacGroup:
	...
	db 86, PORYGON,    RECOVER, PSYCHIC_M, CONVERSION2, TRI_ATTACK
	db -1 ; end

	; POKEMANIAC (11)
	db "ISSAC@", TRAINERTYPE_MOVES
	db 62, LICKITUNG,  LICK, SUPERSONIC, CUT, NO_MOVE
	db -1 ; end
	...
	; POKEMANIAC (14)
	db "BRENT@", TRAINERTYPE_MOVES
	db 91, CHANSEY,    ROLLOUT, ATTRACT, EGG_BOMB, SOFTBOILED
	db -1 ; end
...
BugCatcherGroup:
	...
	db 78, VENOMOTH,   DISABLE, SUPERSONIC, CONFUSION, LEECH_LIFE
	db -1 ; end

	; BUG_CATCHER (15)
	db "WADE@", TRAINERTYPE_MOVES
	db 74, BUTTERFREE, CONFUSION, POISONPOWDER, SUPERSONIC, WHIRLWIND
	db 74, BUTTERFREE, CONFUSION, STUN_SPORE, SUPERSONIC, WHIRLWIND
	db 75, BEEDRILL,   FURY_ATTACK, FOCUS_ENERGY, TWINEEDLE, RAGE
	db 74, BUTTERFREE, CONFUSION, SLEEP_POWDER, SUPERSONIC, WHIRLWIND
	db -1 ; end

	; BUG_CATCHER (16)
	db "WADE@", TRAINERTYPE_MOVES
	db 80, BUTTERFREE, CONFUSION, POISONPOWDER, SUPERSONIC, GUST
	db 80, BUTTERFREE, CONFUSION, STUN_SPORE, SUPERSONIC, GUST
	db 82, BEEDRILL,   FURY_ATTACK, PURSUIT, TWINEEDLE, DOUBLE_TEAM
	db 84, BUTTERFREE, PSYBEAM, SLEEP_POWDER, GUST, WHIRLWIND
	db -1 ; end

	; BUG_CATCHER (17)
	db "ARNIE@", TRAINERTYPE_MOVES
	db 86, VENOMOTH,   GUST, SUPERSONIC, PSYBEAM, LEECH_LIFE
	db -1 ; end

	; BUG_CATCHER (18)
	db "ARNIE@", TRAINERTYPE_MOVES
	db 90, VENOMOTH,   GUST, SUPERSONIC, PSYCHIC_M, TOXIC
	db -1 ; end
...
FisherGroup:
	...
	db 75, OCTILLERY,  LOCK_ON, PSYBEAM, AURORA_BEAM, BUBBLEBEAM
	db 75, OCTILLERY,  LOCK_ON, PSYBEAM, AURORA_BEAM, BUBBLEBEAM
	db -1 ; end
	...
	; FISHER (21) -- Kanto hack (M11 14a, D145): Route 26/27 entry band, Crystal Lv30-43 mapped linearly onto Lv55-62
	...
	db 84, SEAKING,    SUPERSONIC, WATERFALL, FLAIL, FURY_ATTACK
	db 84, SEAKING,    SUPERSONIC, WATERFALL, FLAIL, FURY_ATTACK
	db 88, OCTILLERY,  PSYBEAM, AURORA_BEAM, BUBBLEBEAM, HYPER_BEAM
	db -1 ; end
	...
	db 85, QWILFISH,   TOXIC, MINIMIZE, SURF, PIN_MISSILE
	db 89, SEAKING,    ENDURE, FLAIL, FURY_ATTACK, WATERFALL
	db -1 ; end

	; FISHER (25)
	db "TULLY@", TRAINERTYPE_MOVES
	db 84, SEAKING,    SUPERSONIC, RAIN_DANCE, WATERFALL, FURY_ATTACK
	db 84, SEAKING,    SUPERSONIC, RAIN_DANCE, WATERFALL, FURY_ATTACK
	db 87, QWILFISH,   ROLLOUT, SURF, PIN_MISSILE, TAKE_DOWN
	db -1 ; end
...
SwimmerFGroup:
	...
	db 70, GOLDUCK,    SCRATCH, TAIL_WHIP, DISABLE, CONFUSION
	db 72, SEAKING,    PECK, TAIL_WHIP, SUPERSONIC, HORN_ATTACK
	db -1 ; end
	...
	db 71, SEADRA,     BUBBLE, SMOKESCREEN, LEER, WATER_GUN
	db 71, SEADRA,     DRAGON_RAGE, SMOKESCREEN, LEER, WATER_GUN
	db -1 ; end
...
SailorGroup:
	...
	db 68, KINGLER,    BUBBLE, LEER, VICEGRIP, HARDEN
	db 70, KINGLER,    BUBBLEBEAM, LEER, VICEGRIP, HARDEN
	db -1 ; end
	...
	db 88, POLITOED,   WHIRLPOOL, RAIN_DANCE, BODY_SLAM, PERISH_SONG
	db 88, POLIWRATH,  SURF, STRENGTH, ICE_PUNCH, SUBMISSION
	db -1 ; end
...
SuperNerdGroup:
	...
	db 85, SEADRA,     SMOKESCREEN, TWISTER, SURF, WATERFALL
	db -1 ; end

	; SUPER_NERD (14)
	db "MARKUS@", TRAINERTYPE_MOVES
	db 69, SLOWBRO,    CURSE, WATER_GUN, GROWL, STRENGTH
	db -1 ; end
...
; Kanto hack (M11 14d): Dragon's Den (rows 1-3) 86-90, Mt. Silver foot (4-6) 90-94.
Rival2Group:
	; RIVAL2 (1)
	db "?@", TRAINERTYPE_MOVES
	db 86, SNEASEL,    QUICK_ATTACK, SCREECH, FAINT_ATTACK, FURY_CUTTER
	db 87, GOLBAT,     LEECH_LIFE, BITE, CONFUSE_RAY, WING_ATTACK
	db 86, MAGNETON,   THUNDERSHOCK, SONICBOOM, THUNDER_WAVE, SWIFT
	db 88, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 88, ALAKAZAM,   DISABLE, RECOVER, FUTURE_SIGHT, PSYCHIC_M
	db 90, MEGANIUM,   RAZOR_LEAF, POISONPOWDER, BODY_SLAM, LIGHT_SCREEN
	db -1 ; end
	...
	db 88, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 88, ALAKAZAM,   DISABLE, RECOVER, FUTURE_SIGHT, PSYCHIC_M
	db 90, TYPHLOSION, SMOKESCREEN, QUICK_ATTACK, FLAME_WHEEL, SWIFT
	db -1 ; end
	...
	db 88, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 88, ALAKAZAM,   DISABLE, RECOVER, FUTURE_SIGHT, PSYCHIC_M
	db 90, FERALIGATR, RAGE, WATER_GUN, SCARY_FACE, SLASH
	db -1 ; end

	; RIVAL2 (4)
	db "?@", TRAINERTYPE_MOVES
	db 90, SNEASEL,    QUICK_ATTACK, SCREECH, FAINT_ATTACK, FURY_CUTTER
	db 92, CROBAT,     TOXIC, BITE, CONFUSE_RAY, WING_ATTACK
	db 90, MAGNETON,   THUNDER, SONICBOOM, THUNDER_WAVE, SWIFT
	db 91, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 91, ALAKAZAM,   RECOVER, FUTURE_SIGHT, PSYCHIC_M, REFLECT
	db 94, MEGANIUM,   GIGA_DRAIN, BODY_SLAM, LIGHT_SCREEN, SAFEGUARD
	db -1 ; end
	...
	db 91, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 91, ALAKAZAM,   RECOVER, FUTURE_SIGHT, PSYCHIC_M, REFLECT
	db 94, TYPHLOSION, SMOKESCREEN, QUICK_ATTACK, FIRE_BLAST, SWIFT
	db -1 ; end
	...
	db 91, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 91, ALAKAZAM,   RECOVER, FUTURE_SIGHT, PSYCHIC_M, REFLECT
	db 94, FERALIGATR, SURF, RAIN_DANCE, SLASH, SCREECH
	db -1 ; end
...
HikerGroup:
	...
	db 77, DUGTRIO,    MAGNITUDE, DIG, SAND_ATTACK, SLASH
	db 77, DUGTRIO,    MAGNITUDE, DIG, SAND_ATTACK, SLASH
	db -1 ; end
	...
	db 85, DUGTRIO,    MAGNITUDE, DIG, MUD_SLAP, SLASH
	db 88, STEELIX,    DIG, IRON_TAIL, SANDSTORM, SLAM
	db -1 ; end
	...
	db 84, GRAVELER,   MAGNITUDE, SELFDESTRUCT, DEFENSE_CURL, ROLLOUT
	db 86, GOLEM,      MAGNITUDE, SELFDESTRUCT, DEFENSE_CURL, ROLLOUT
	db 84, MACHOKE,    KARATE_CHOP, VITAL_THROW, HEADBUTT, DIG
	db -1 ; end
...
BurglarGroup:
	...
	db 76, GROWLITHE,  ROAR, EMBER, LEER, TAKE_DOWN
	db 74, WEEZING,    TACKLE, SMOG, SLUDGE, SMOKESCREEN
	db -1 ; end
...
BlackbeltGroup:
	...
	db 77, HITMONLEE,  DOUBLE_KICK, MEDITATE, JUMP_KICK, FOCUS_ENERGY
	db -1 ; end
	...
	db 77, HITMONCHAN, COMET_PUNCH, THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH
	db -1 ; end

	; BLACKBELT_T (5)
	db "NOB@", TRAINERTYPE_MOVES
	db 75, MACHOKE,    LEER, FOCUS_ENERGY, KARATE_CHOP, SEISMIC_TOSS
	db 75, MACHOKE,    LEER, KARATE_CHOP, SEISMIC_TOSS, ROCK_SLIDE
	db -1 ; end
...
ExecutiveMGroup:
	...
	db 83, HOUNDOOM,   EMBER, ROAR, BITE, FAINT_ATTACK
	db 83, WEEZING,    TACKLE, SLUDGE, SMOKESCREEN, HAZE
	db 85, HOUNDOOM,   EMBER, SMOG, BITE, FAINT_ATTACK
	db -1 ; end

	; EXECUTIVEM (2)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 86, GOLBAT,     LEECH_LIFE, BITE, CONFUSE_RAY, WING_ATTACK
	db -1 ; end

	; EXECUTIVEM (3)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 80, WEEZING,    TACKLE, SELFDESTRUCT, SLUDGE, SMOKESCREEN
	db 80, WEEZING,    TACKLE, SELFDESTRUCT, SLUDGE, SMOKESCREEN
	db 80, WEEZING,    TACKLE, SELFDESTRUCT, SLUDGE, SMOKESCREEN
	db 82, WEEZING,    TACKLE, EXPLOSION, SLUDGE, SMOKESCREEN
	db 80, WEEZING,    TACKLE, SELFDESTRUCT, SLUDGE, SMOKESCREEN
	db 80, WEEZING,    TACKLE, SMOG, SLUDGE, SMOKESCREEN
	db -1 ; end
...
PsychicGroup:
	...
	db 67, HYPNO,      HYPNOSIS, DISABLE, DREAM_EATER, NO_MOVE
	db -1 ; end

	; PSYCHIC_T (5)
	db "NORMAN@", TRAINERTYPE_MOVES
	db 67, SLOWBRO,    TACKLE, GROWL, WATER_GUN, NO_MOVE
	db 70, SLOWBRO,    CURSE, BODY_SLAM, WATER_GUN, CONFUSION
	db -1 ; end

	; PSYCHIC_T (6)
	db "MARK@", TRAINERTYPE_MOVES
	db 63, KADABRA,    TELEPORT, FLASH, NO_MOVE, NO_MOVE
	db 63, KADABRA,    TELEPORT, FLASH, NO_MOVE, NO_MOVE
	db 65, KADABRA,    TELEPORT, KINESIS, CONFUSION, NO_MOVE
	db -1 ; end

	; PSYCHIC_T (7)
	db "PHIL@", TRAINERTYPE_MOVES
	db 74, XATU,       LEER, NIGHT_SHADE, FUTURE_SIGHT, CONFUSE_RAY
	db 76, KADABRA,    DISABLE, PSYBEAM, RECOVER, FUTURE_SIGHT
	db -1 ; end

	; PSYCHIC_T (8) -- Kanto hack (M11 14a, D145): Route 26/27 entry band, Crystal Lv30-43 mapped linearly onto Lv55-62
	db "RICHARD@", TRAINERTYPE_NORMAL
	db 58, ESPEON
	db -1 ; end

	; PSYCHIC_T (9) -- Kanto hack (M11 14a, D145): Route 26/27 entry band, Crystal Lv30-43 mapped linearly onto Lv55-62
...
PicnickerGroup:
	...
	db 66, PIKACHU,    THUNDERSHOCK, GROWL, QUICK_ATTACK, DOUBLE_TEAM
	db -1 ; end
	...
	db 81, CLEFAIRY,   ENCORE, SING, DOUBLESLAP, MINIMIZE
	db -1 ; end

	; PICNICKER (17)
	db "TIFFANY@", TRAINERTYPE_MOVES
	db 87, CLEFAIRY,   ENCORE, DOUBLESLAP, MINIMIZE, METRONOME
	db -1 ; end
	...
	; PICNICKER (20)
	db "TIFFANY@", TRAINERTYPE_MOVES
	db 70, CLEFAIRY,   ENCORE, SING, DOUBLESLAP, MINIMIZE
	db -1 ; end

	; PICNICKER (21)
	db "ERIN@", TRAINERTYPE_MOVES
	db 86, RAPIDASH,   DOUBLE_TEAM, STOMP, FIRE_SPIN, SUNNY_DAY
	db 84, RAICHU,     SWIFT, MUD_SLAP, QUICK_ATTACK, THUNDERBOLT
	db 86, RAPIDASH,   DOUBLE_TEAM, STOMP, FIRE_SPIN, SUNNY_DAY
	db -1 ; end
	...
	db 80, WEEPINBELL, SLEEP_POWDER, POISONPOWDER, STUN_SPORE, SLUDGE_BOMB
	db 82, NIDOKING,   EARTHQUAKE, DOUBLE_KICK, POISON_STING, IRON_TAIL
	db 82, NIDOQUEEN,  EARTHQUAKE, DOUBLE_KICK, TAIL_WHIP, BODY_SLAM
	db -1 ; end
	...
	db 83, JUMPLUFF,   STUN_SPORE, SUNNY_DAY, LEECH_SEED, COTTON_SPORE
	db 83, JUMPLUFF,   SUNNY_DAY, SLEEP_POWDER, LEECH_SEED, COTTON_SPORE
	db 88, VENUSAUR,   SOLARBEAM, RAZOR_LEAF, HEADBUTT, MUD_SLAP
	db -1 ; end

	; PICNICKER (26)
	db "TIFFANY@", TRAINERTYPE_MOVES
	db 93, CLEFAIRY,   METRONOME, ENCORE, MOONLIGHT, MINIMIZE
	db -1 ; end
...
CamperGroup:
	...
	db 83, GRAVELER,   SELFDESTRUCT, ROCK_THROW, HARDEN, MAGNITUDE
	db 83, GRAVELER,   SELFDESTRUCT, ROCK_THROW, HARDEN, MAGNITUDE
	db 86, MAGCARGO,   ROCK_THROW, HARDEN, AMNESIA, FLAMETHROWER
...
ExecutiveFGroup:
	; EXECUTIVEF (1)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 82, ARBOK,      WRAP, POISON_STING, BITE, GLARE
	db 82, VILEPLUME,  ABSORB, SWEET_SCENT, SLEEP_POWDER, ACID
	db 82, MURKROW,    PECK, PURSUIT, HAZE, NIGHT_SHADE
	db -1 ; end

	; EXECUTIVEF (2)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 73, ARBOK,      WRAP, LEER, POISON_STING, BITE
	db 73, GLOOM,      ABSORB, SWEET_SCENT, SLEEP_POWDER, ACID
	db 75, MURKROW,    PECK, PURSUIT, HAZE, NO_MOVE
	db -1 ; end
...
TwinsGroup:
	...
	db 66, CLEFAIRY,   GROWL, ENCORE, DOUBLESLAP, METRONOME
	db 66, JIGGLYPUFF, SING, DEFENSE_CURL, POUND, DISABLE
	db -1 ; end
	...
	db 85, DRAGONITE,  THUNDER_WAVE, TWISTER, FLAMETHROWER, HEADBUTT
	db 85, DRAGONITE,  THUNDER_WAVE, TWISTER, ICE_BEAM, HEADBUTT
	db -1 ; end
...
GruntFGroup:
	...
	db 68, ARBOK,      WRAP, LEER, POISON_STING, BITE
	db 68, GLOOM,      ABSORB, SWEET_SCENT, STUN_SPORE, SLEEP_POWDER
	db -1 ; end
...
KantoChampionGroup:
	...
	; Kanto hack (M10 13k2): the rival as VIRIDIAN GYM leader after the Kanto E4
	; (operator ruling 2026-09-22: his Champion team +5-8 levels).  Rows 4-6 =
	; rows 1-3 with every level +6; the moves are re-derived at the new levels
	; with Yellow's WriteMonMoves + SpecialTrainerMoves (RIVAL3 1-3) and come out
	; identical -- no Gen 1 learnset has a move between L59 and L71 for these.
	; KANTO_CHAMPION_4 (JOLTEON)
	db "?@", TRAINERTYPE_MOVES
	db 67, SANDSLASH,  SLASH, POISON_STING, EARTHQUAKE, FURY_SWIPES
	db 65, ALAKAZAM,   PSYBEAM, RECOVER, PSYCHIC_M, KINESIS
	db 67, EXEGGUTOR,  BARRAGE, HYPNOSIS, STOMP, LEECH_SEED
	db 67, CLOYSTER,   ICE_BEAM, CLAMP, AURORA_BEAM, SPIKE_CANNON
	db 69, NINETALES,  CONFUSE_RAY, TAIL_WHIP, QUICK_ATTACK, FIRE_SPIN
	db 71, JOLTEON,    PIN_MISSILE, THUNDER_WAVE, QUICK_ATTACK, THUNDER
	db -1 ; end

	; KANTO_CHAMPION_5 (FLAREON)
	db "?@", TRAINERTYPE_MOVES
	db 67, SANDSLASH,  SLASH, POISON_STING, EARTHQUAKE, FURY_SWIPES
	db 65, ALAKAZAM,   PSYBEAM, RECOVER, PSYCHIC_M, KINESIS
	db 67, EXEGGUTOR,  BARRAGE, HYPNOSIS, STOMP, LEECH_SEED
	db 67, MAGNETON,   THUNDERBOLT, THUNDER_WAVE, SWIFT, SCREECH
	db 69, CLOYSTER,   ICE_BEAM, CLAMP, AURORA_BEAM, SPIKE_CANNON
	db 71, FLAREON,    FIRE_SPIN, REFLECT, QUICK_ATTACK, FLAMETHROWER
	db -1 ; end

	; KANTO_CHAMPION_6 (VAPOREON)
	db "?@", TRAINERTYPE_MOVES
	db 67, SANDSLASH,  SLASH, POISON_STING, EARTHQUAKE, FURY_SWIPES
	db 65, ALAKAZAM,   PSYBEAM, RECOVER, PSYCHIC_M, KINESIS
	db 67, EXEGGUTOR,  BARRAGE, HYPNOSIS, STOMP, LEECH_SEED
	db 67, NINETALES,  CONFUSE_RAY, TAIL_WHIP, QUICK_ATTACK, FIRE_SPIN
	db 69, MAGNETON,   THUNDERBOLT, THUNDER_WAVE, SWIFT, SCREECH
	db 71, VAPOREON,   AURORA_BEAM, MIST, QUICK_ATTACK, HYDRO_PUMP
	db -1 ; end
...
MysticalmanGroup:
	...
	db 73, HAUNTER,    LICK, HYPNOSIS, MEAN_LOOK, CURSE
	db 75, ELECTRODE,  SCREECH, SONICBOOM, THUNDER, ROLLOUT
	db -1 ; end
