...
; (vendor/pokeyellow/engine/items/item_effects.asm ItemUsePokeFlute).
; Both menus are ITEMMENU_CLOSE.  The FIELD menu was ITEMMENU_NOUSE until PE1
; (docs/M6-TOWER.md D26 deferred it): PokeFluteEffect now has Yellow's
; overworld half back -- the Pewter #MON Center Pikachu wake (emotion 26), the
; two SNORLAX (it runs D20's object scripts from Yellow's flute tiles), and
; "Now, that's a catchy tune!" everywhere else.  It never wakes the party
; outside battle, as Yellow never does.
; CANT_SELECT: Yellow had no SELECT registration at all.
	item_attribute 0, HELD_NONE, 0, CANT_SELECT | CANT_TOSS, KEY_ITEM, ITEMMENU_CLOSE, ITEMMENU_CLOSE
; EXP_SHARE
...
; SECRET_KEY (was MACHINE_PART; M9 12m) -- Yellow: key item, unusable, can't toss
	item_attribute 0, HELD_NONE, 0, CANT_SELECT | CANT_TOSS, KEY_ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; EGG_TICKET
	item_attribute 0, HELD_NONE, 0, CANT_SELECT | CANT_TOSS, KEY_ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; LOST_ITEM
