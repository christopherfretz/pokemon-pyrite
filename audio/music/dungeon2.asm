; Kanto hack (K6c, docs/K6-MUSIC.md): Yellow's DUNGEON2 (Viridian Forest / Diglett's Cave / Seafoam) theme, a source-level
; port of pokeyellow audio/music/dungeon2.asm (header from
...
; Replaces the MUSIC_ROUTE_2 / MT_MOON stand-ins.
